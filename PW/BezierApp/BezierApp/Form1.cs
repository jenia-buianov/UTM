    ...
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Click(object sender, MouseEventArgs e)
        {
           ...
           if (points[0].X == 0 || points[1].X == 0)
            {
                   MessageBox.Show("Please select another point");
                   return;
             }
            ...
            System.Drawing.Point p2 = new System.Drawing.Point(points[0].X, points[0].Y);
            System.Drawing.Point p3 = new System.Drawing.Point(points[1].X, points[1].Y);
